...
var collided = false;
function preload() {
  zombie1 = loadImage("./assets/jacare3.png");
  zombie2 = loadImage("./assets/jacare3.png");
  zombie3 = loadImage("./assets/jacare3.png");
  zombie4 = loadImage("./assets/jacare3.png");
  sadzombie = loadImage("./assets/jacare1.png");
